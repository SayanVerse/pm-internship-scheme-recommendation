...
export default function Intake() {
  ...
  return (
    <div className="min-h-screen bg-gradient-neon relative overflow-hidden floating-elements">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-gradient-to-r from-green-400/15 to-purple-500/15 rounded-full blur-3xl gpu decorative will-filter"></div>
