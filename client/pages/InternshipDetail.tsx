            ...
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                ...
                <p className="text-white/70">
                  ...
                  application process, and company information will be
                  implemented here.
                </p>
                <div className="space-y-4">
                  ...
                  <p className="text-white/50 text-sm">
                    This page will show full internship details, eligibility
                    criteria, application deadlines, and allow direct
                    application.
                  </p>
                </div>
              </div>
