...
export default function Index() {
  ...
  const content = {
    ...
    hi: {
      ...
      findCTA: "सर्वश्रेष्ठ इंटर्नशि�� खोजें 🗃️",
      ...
      features: [
        ...
        },
        {
          ...
          title: "करियर विकास",
          description:
            "वेतन-आधारित इंटर्नशिप कार्यक्रमों के साथ व्यावहारिक क���शल बनाएं और मूल्यवान कार्य अनुभव प्राप्�� क��ें।",
        },
        {
          icon: Globe,
    ...
    bn: {
      ...
      subtitle:
        "PM ইন্টার্নশিপ স্কিমের প্��ার্থীদের ��ন্য AI-চালিত সুপারিশ। আপনার দক্ষতা এবং পছন্দের উপর ভিত্তি করে ৩-৫টি ব্যক্তিগতকৃত ইন্টার্নশিপ প���ামর্শ পান।",
