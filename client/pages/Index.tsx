...
export default function Index() {
  ...
  const content = {
    ...
    hi: {
      ...
      subtitle:
        "पीएम इंटर्नशिप योजना के उम्मीदवारों के लिए AI-संचालित सिफारिशें। ��पने कौ����� और प्राथमिकताओं के आधार पर 3-5 व्यक्तिगत इंटर्नशिप सुझ���व प्राप्त करें।",
      findCTA: "सर्वश्रेष्ठ इंटर���नशिप खोजें 🗃️",
      ...
      features: [
        ...
        },
        {
          ...
          title: "करियर विकास",
          description:
            "वेतन-आधारित इंटर्नशिप कार्यक्रमों के साथ व्यावहारिक क���शल बनाएं और मूल्यवान कार्य अनुभव प्राप���� करें।",
        },
        {
          icon: Globe,
    ...
    bn: {
      ...
      subtitle:
        "PM ইন্টার্নশিপ স্কিমের প্��ার্থীদের ��ন্য AI-চালিত সুপারিশ। আপনার দক্ষতা এবং পছন্দের উপর ভিত্তি করে ৩-৫টি ব্যক্তিগতকৃত ইন্টার্ন���িপ পরামর্শ পান।",
  ...
  function getBotReply(input: string) {
    ...
    // Data-aware answers from trained CSV
