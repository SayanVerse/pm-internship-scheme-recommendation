...
export default function Index() {
  ...
  const content = {
    ...
    hi: {
      ...
      findCTA: "सर���वश्रेष्ठ इंटर्नशिप खोजें 🗃️",
    ...
    bn: {
      ...
      subtitle:
        "PM ইন্টার্নশিপ স্কিমের প্��ার্থীদের ��ন্য AI-চালিত সুপারিশ। আপনার দক্ষতা এবং পছন্দের উপর ভিত্তি করে ৩-৫টি ব্যক্তি���তকৃত ইন্টার্নশিপ পরামর্শ পান।",
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 mb-12 sm:mb-20 px-2">
            {currentContent.stats.map((stat, index) => (
              <div key={index} className="glass-card p-3 sm:p-6 text-center text-neutral-900 dark:text-white">
                ...
                <div className="text-neutral-600 dark:text-white/80 text-xs sm:text-sm md:text-base">
                  {stat.label}
                </div>
              </div>
            ))}
