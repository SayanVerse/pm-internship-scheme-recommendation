...
export default function Index() {
  ...
  const content = {
    ...
    hi: {
      ...
      subtitle:
        "पीएम इंटर्नशिप योजना के उम्मीदवारों के लिए AI-संचालित सिफारिशें। अपने कौश��� और प्राथमिकताओं के आधार पर 3-5 व्यक्तिगत इंटर्नशिप सुझाव प्राप्त करें।",
    ...
    bn: {
      ...
      subtitle:
        "PM ইন্টার্নশিপ স্কিমের প্রার্থীদের ��ন্য AI-চালিত সুপারিশ। আপনার দক্ষতা এবং পছন্দের উপর ভিত্তি করে ৩-৫টি ব্যক্তিগতকৃত ইন্টার্নশিপ পরামর্শ পান।",
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "বৃত্তি-ভিত্তিক ইন্টার্���শিপ প্রোগ্রামের সাথে ব্যবহারিক দক্ষতা তৈরি কর��ন এবং মূল্যবান কাজের অভিজ্ঞতা অর্জন করুন।",
        },
        {
          icon: Globe,
          ...
          {showChat && (
            <div className="fixed bottom-24 right-6 z-50 w-80 max-w-[90vw] rounded-2xl shadow-2xl glass-card border-white/20 bg-white/95">
              <div className="flex items-center justify-between px-4 py-3 border-b border-white/20">
                <div>
                  <div className="text-base font-semibold text-white light:text-black">InternGuide</div>
                  <div className="text-xs text-white/70 light:text-black/70">Your internship helper</div>
                </div>
                <button
                  aria-label="Close chat"
                  onClick={() => setShowChat(false)}
                  className="text-white/80 hover:text-white light:text-black/80 light:hover:text-black"
                >
                  ×
                </button>
              </div>
