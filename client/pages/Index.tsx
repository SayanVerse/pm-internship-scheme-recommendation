...
export default function Index() {
  ...
  const content = {
    ...
    hi: {
      ...
      subtitle:
        "पीएम इंटर्नशिप योजना के उम्मीदवारों ���े लिए AI-संचालित सिफारिशें। अपने कौश��� और प्राथमिकताओं के आधार पर 3-5 व्यक्तिगत इंटर्नशिप सुझाव प्राप्त करें।",
    ...
    bn: {
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "IT, স্বাস্থ্যসেবা, কৃষি, শিক্ষা এবং পাবলিক অ্যাডমি���িস্ট্রেশন সেক্টরে কিউরেটেড ইন্টার্নশিপ।",
        },
        {
          icon: TrendingUp,
