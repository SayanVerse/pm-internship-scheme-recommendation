...
async function main() {
  ...
  const internships = [
    ...
    },
    {
      ...
      description:
        "Analyze healthcare data and create insights using Python and Excel",
      stipendMin: 12000,
      stipendMax: 18000,
      city: "Mumbai",
      state: "Maharashtra",
    ...
    },
    {
      ...
      description:
        "Support farmers with modern agricultural techniques and technology adoption",
      stipendMin: 8000,
      stipendMax: 12000,
      city: "Pune",
      state: "Maharashtra",
    ...
    },
    {
      ...
      orgName: "EduInnovate",
      description:
        "Develop educational content and support online learning platforms",
      stipendMin: 10000,
      stipendMax: 15000,
      city: "Delhi",
      state: "Delhi",
    ...
    },
    {
      ...
      description:
        "Support public health programs and analyze health data at district level",
      stipendMin: 15000,
      stipendMax: 20000,
      city: "Chennai",
      state: "Tamil Nadu",
    ...
    },
    {
      ...
      description:
        "Create digital marketing campaigns and analyze performance metrics",
      stipendMin: 8000,
      stipendMax: 14000,
      city: "Hyderabad",
      state: "Telangana",
    ...
    },
    {
      ...
      description:
        "Support financial planning and analysis for rural microfinance programs",
      stipendMin: 12000,
      stipendMax: 18000,
      city: "Jaipur",
      state: "Rajasthan",
